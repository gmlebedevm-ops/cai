      ...
      <div className="container mx-auto p-6">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Загрузка моих согласований...</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold">Мои согласования</h1>
          <p className="text-muted-foreground">
            Согласования, назначенные вам • Всего: {pagination.total}
          </p>
        </div>
      </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  {searchTerm || statusFilter !== 'all' 
                    ...
                    : 'У вас пока нет назначенных согласований'
                  }
                </p>
              </div>
            </CardContent>
