...
export default function ContractsPage() {
  ...
  }, [searchTerm, statusFilter, counterpartyFilter])
      ...
      <div className="container mx-auto p-6">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Загрузка договоров...</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold">Договоры</h1>
          <p className="text-muted-foreground">
            Управление договорами • Всего: {pagination.total}
          </p>
        </div>
        <Button 
            ...
            {contracts.length === 0 && (
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Договоры не найдены</h3>
                  <p className="text-muted-foreground mb-4">
                    {searchTerm || statusFilter !== 'all' || counterpartyFilter !== 'all' 
                      ? 'Попробуйте изменить параметры фильтрации'
                      : 'Начните с создания первого договора'
                    }
                  </p>
                  {(!searchTerm && statusFilter === 'all' && counterpartyFilter === 'all') && (
